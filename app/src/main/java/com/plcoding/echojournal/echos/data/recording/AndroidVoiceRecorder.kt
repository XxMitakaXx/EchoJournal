...
class AndroidVoiceRecorder(
    ...
    companion object {
        private const val MAX_AMPLITUDE_VALUE = 26000L
    }
    ...
    private fun startTrackAmplitude() {
    ...
    private fun startTrackDuration() {
    ...
    private fun cleanup() {
        Timber.e("Cleaning up voice recorder resources")
        recorder = null
        isRecording = false
        isPaused = false
        durationJob?.cancel()
