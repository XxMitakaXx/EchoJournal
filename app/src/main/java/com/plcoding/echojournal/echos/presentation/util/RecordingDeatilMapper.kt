...
fun RecordingDetails.toCreateEchoDetail(): NavigationRoute.CreateEcho {
    return NavigationRoute.CreateEcho(
        recordingPath = this.filePath ?: throw IllegalArgumentException(
            "Record path can't be null."
        ),
...
fun NavigationRoute.CreateEcho.toRecordingDetail(): RecordingDetails {
