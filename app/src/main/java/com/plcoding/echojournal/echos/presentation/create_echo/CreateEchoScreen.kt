...
import com.plcoding.echojournal.core.presentation.designsystem.text_fiels.TransparentHintTextField
import com.plcoding.echojournal.core.presentation.designsystem.theme.EchoJournalTheme
import com.plcoding.echojournal.core.presentation.designsystem.theme.secondary70
import com.plcoding.echojournal.core.presentation.designsystem.theme.secondary90
...
fun CreateEchoScreen(
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    IconButton(
                        onClick = {
                            onAction(CreateEchoAction.OnNavigationBackClick)
                        }
                    ) {
                        Icon(
        ...
        Column(
            ...
            Row(
                ...
                if (state.mood == null) {
                    FilledIconButton(
                        ...
                        colors = IconButtonDefaults.filledIconButtonColors(
                            containerColor = MaterialTheme.colorScheme.secondary90,
                            contentColor = MaterialTheme.colorScheme.secondary70
                        )
                    ) {
                        Icon(
                            imageVector = Icons.Filled.Add,
                            contentDescription = stringResource(R.string.all_moods)
                        )
                    }
                } else {
                    Image(
                ...
                TransparentHintTextField(
                    ...
                    onValueChange = {
                        onAction(CreateEchoAction.OnTitleValueChange(it))
                    },
                    modifier = Modifier
                        .weight(1f),
            ...
            EchoTopicsRow(
                ...
                onAddTopicTextChange = {
                    onAction(CreateEchoAction.OnAddTopicChangeText(it))
                }
            )
        ...
        if (state.showConfirmLeaveDialog) {
            AlertDialog(
                onDismissRequest = {
                    onAction(CreateEchoAction.OnDismissConfirmDialog)
                },
                confirmButton = {
                    TextButton(
                ...
                text = {
                    Text(
                        text = stringResource(R.string.this_connot_be_undone)
                    )
                }
            )
        }
